            ...
            if item.id_number == wybrany_material:
                if self.uzytkownicy[
                    ...
                    if item.jest_dostepne:  # sprawdzam czy material jest dostepny i zmniejszam dostepna liczbe o jeden
                        ...
                        self.listaZamowien.append((len(self.listaZamowien), self.logged_id, wybrany_material)) # do listy zamowien dodaje nowy element/zamowienie skladajace sie z id zamowienia, id zamawiajacego oraz id zamawianego przedmiotu
