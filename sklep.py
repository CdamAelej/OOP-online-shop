...
class Sklep:
            ...
            if item.id_number == wybrany_material:
                if self.uzytkownicy[
                    ...
                    if item.jest_dostepne:  # sprawdzam czy material jest dostepny i zmniejszam dostepna liczbe o jeden
                        ...
                        Zamowienie().lista_zamowien.append((len(Zamowienie().lista_zamowien), self.logged_id, wybrany_material)) # do listy zamowien dodaje nowy element/zamowienie skladajace sie z id zamowienia, id zamawiajacego oraz id zamawianego przedmiotu
    ...
    def pokaz_zamowienie(self):
        for item in Zamowienie().lista_zamowien:
            print(item)
